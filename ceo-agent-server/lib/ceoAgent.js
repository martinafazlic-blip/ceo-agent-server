...
export async function generateDailyReport(state) {
  ...
  const summary = allTasks
    ...
    .join("\n");
  const system = `Sei il CEO Agent. Produci un report giornaliero conciso in italiano (massimo 180 parole, testo semplice) con: Situazione generale:, Risultati:, Problemi:, Priorita di oggi:. Tono elegante, misurato e diretto, come un maggiordomo/direttore generale di alto livello che riferisce con precisione e un tocco di garbo, senza mai risultare invadente o eccessivamente informale.`;
